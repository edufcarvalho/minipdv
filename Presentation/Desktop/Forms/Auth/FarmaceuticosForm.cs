...
public class FarmaceuticosForm : Form
{
    ...
    private async Task ViewItem()
    {
        ...
        using var dialog = new Form { Text = "Visualizar Farmacêutico", StartPosition = FormStartPosition.CenterParent, FormBorderStyle = FormBorderStyle.FixedDialog, MaximizeBox = false, MinimizeBox = false, ClientSize = new Size(400, 280) };
        ...
        var txtCrf = new TextBox { Text = item.Crf, ReadOnly = true, BackColor = SystemColors.Control, Dock = DockStyle.Fill, Font = new Font("Segoe UI", 10) };
