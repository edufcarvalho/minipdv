...
public class FarmaceuticosForm : Form
{
    ...
    private async Task ViewItem()
    {
        ...
        using var dialog = FormComponents.CreateDialog("Visualizar Farmacêutico", 400, 280);
        ...
        tbl.Controls.Add(FormComponents.CreateFieldLabel("CRF:"), 0, 2);
        tbl.Controls.Add(FormComponents.CreateReadOnlyTextBox(item.Crf), 1, 2);
    ...
    {
        using var dialog = FormComponents.CreateDialog("Novo Farmacêutico", 400, 280);
        var tbl = FormComponents.CreateDialogLayout(2, 7, 100);
        ...
        tbl.Controls.Add(FormComponents.CreateFieldLabel("CRF:"), 0, 3);
        var txtCrf = FormComponents.CreateTextBox();
    ...
    private async Task EditItem()
    {
        ...
        using var dialog = FormComponents.CreateDialog("Editar Farmacêutico", 400, 320);
        ...
        tbl.Controls.Add(FormComponents.CreateFieldLabel("CRF:"), 0, 3);
        var txtCrf = FormComponents.CreateTextBox(item.Crf);
        tbl.Controls.Add(txtCrf, 1, 3);
