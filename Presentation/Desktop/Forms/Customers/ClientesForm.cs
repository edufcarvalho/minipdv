...
public class ClientesForm : Form
{
    ...
    private async Task ViewItem()
    {
        ...
        var mtxtCpf = new MaskedTextBox { Mask = "000.000.000-00", Culture = CultureInfo.InvariantCulture, Text = item.Cpf, Enabled = false, ReadOnly = true, Dock = DockStyle.Fill, Font = new Font("Segoe UI", 10) };
